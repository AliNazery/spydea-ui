          ...
          <div className="row items-center">
            <div className="lg:mx-auto text-center px-3 lg:w-7/12 box-border flex-shrink-0 w-full max-w-[100%]">
                ...
                >
                  <ol className="inline-flex" role="list">
                    ...
                    >
                      ...
                      <span className="text-dark align-middle">Authors</span>
                    </li>
                  </ol>
                </nav>
              </div>
              ...
              <p
                ...
                data-aos-delay="100"
              >
                Vivamus accu msan tincidunt. Vestib ulum ac diam sit amet quam
                vehicula elementum sed suscipit tortor eget felis porttitor
                volut
              </p> */}
            </div>
          </div>
