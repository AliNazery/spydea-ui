    ...
    <main>
            ...
            <div className="container relative mb-[40px] z-30" >
                <div className="row items-center">
                    <div className="mx-auto mb-[40px] text-center lg:col-7">
                        <h1 className="mb-12 text-4xl font-bold sm:text-[50px] xl:text-[65px]" data-aos="fade-up-sm">Latest Blog Posts</h1>
                            ...
                            <nav aria-label="Breadcrumb" className="ml-auto mr-auto mb-6 flex w-fit gap-10">
                                <ol className="inline-flex list-none m-0 p-0" role="list">
                                    ...
                                    <li className="relative  align-middle text-xl font-medium" role="listitem">
                                        ...
                                        <span className="text- align-middle">Blog</span>
                                    </li>
                                </ol>
                            </nav>
                        </div>
        ...
        <section className='section-md relative mt-[-28rem] overflow-hidden md:mt-[-32rem] mb-36'>
            <div className='container relative z-30'>
                ...
                <nav className='mt-8 flex items-center justify-center space-x-3' aria-label="Pagination">
                    ...
                    className='rounded bg-black px-4 py-2 text-white'>1</span>
                    <a href="nextblog page  "aria-current="page"
                    className='rounded px-4 py-2 text-dark hover:bg-theme-light  '>2</a>
                    <a href=""
