  ...
  return (
    <>
      <main>
        ...
        <section className="section-md relative mt-[-28rem] overflow-hidden md:mt-[-32rem] mb-36">
          <div className="container relative z-30">
            <div className="flex flex-wrap mt-36 -mx-3 space-y-3">
              <div
                data-aos="fade-up-sm"
                className="md:col-6 lg:flex-none w-1/3 box-border  max-w-full px-3 mt-0"
              >
              ...
              <div
                data-aos="fade-up-sm"
                className="md:col-6 md:col-6 lg:flex-none w-1/3 box-border  max-w-full px-3 mt-0"
              >
                <div className="shadow-default group min-h-full overflow-hidden rounded-xl bg-white">
                  <a
                    className="inline-block h-full max-h-[270px] w-full overflow-hidden"
          ...
          <div className='class="pointer-events-none absolute left-0 top-[40%] select-none"'>
            <svg
