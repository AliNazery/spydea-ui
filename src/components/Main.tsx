                ...
                <div className="container relative mb-[40px] z-30" >
                    <div className="row items-center">
                        <div className="mx-auto mb-[40px] text-center lg:col-7">
                            <h1 className="mb-12 text-4xl font-bold sm:text-[50px] xl:text-[65px]" data-aos="fade-up-sm">About Spydea</h1>
                                ...
                                <nav aria-label="Breadcrumb" className="ml-auto mr-auto mb-6 flex w-fit gap-10">
                                    <ol className="inline-flex list-none m-0 p-0" role="list">
                                        ...
                                        <li className="relative  align-middle text-xl font-medium" role="listitem">
                                            ...
                                            <span className="text- align-middle">About</span>
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                            ...
                            <p className="mb-6 text-[20px]  " data-aos="fade-up-sm" data-aos-delay="100">Vivamus accu msan tincidunt. Vestib ulum ac diam sit amet <br /> quam vehicula elementum sed suscipit tortor eget felis porttitor volut</p>
                        </div>
                    </div>
                </div>
