            ...
            <div className="sm:w-2/3 lg:w-2/5 flex flex-col flex-1 relative z-20 ">
                ...
                <div className="flex mt-4 ">
                    <form className="my-10 flex w-full max-w-[600px] flex-col justify-between rounded-md bg-white p-[6px] shadow-md sm:flex-row aos-init aos-animate">
                        ...
                        <button type="submit"
                            className="btn btn-primary py-4 px-11">
                            Search
                        </button>
                    </form>
                </div>
                ...
                <ul className="mt-2 flex flex-row gap-8 align-middle text-[28px] xs:ml-7 xs:mt-0 xs:inline-flex">
                    <li className="text-dark aos-init aos-animate">
                        <a href="#" className="bg-transparent text-inherit decoration-inherit">
                            <svg 
                            stroke="currentColor"
                            fill="currentColor"
                            stroke-width="0"
                ...
                <ul className="flex flex-wrap gap-x-6 gap-y-2">
                    <li className="aos-init aos-animate">
                        <svg className="mr-2 inline-block text-2xl text-emerald-400"
                        stroke="currentColor"
                        fill="currentColor"
                        stroke-width="0"
                        viewBox="0 0 16 16"
                        ...
                        <p className="inline-block align-middle text-lg font-medium text-dark">Works Anywhere</p>
                    </li>
                    <li className="aos-init aos-animate">
                        <svg className="mr-2 inline-block text-2xl text-emerald-400"
                        stroke="currentColor"
                        ...
                        <p className="inline-block align-middle text-lg font-medium text-dark">Get Rewarded</p>
                    </li>
                    <li className="aos-init aos-animate">
                        <svg className="mr-2 inline-block text-2xl text-emerald-400"
                        stroke="currentColor"
                        ...
                        <p className="inline-block align-middle text-lg font-medium text-dark">No Hidden Fees</p>
                    </li>
                </ul>
